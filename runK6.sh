...
wget https://github.com/ozkanpakdil/rust-examples/releases/download/latest/gotham-rest-api
wget https://github.com/ozkanpakdil/rust-examples/releases/download/latest/poem-rest-api
wget https://github.com/ozkanpakdil/rust-examples/releases/download/latest/salvo-rest-api
wget https://github.com/ozkanpakdil/rust-examples/releases/download/latest/trillium-rest-api
wget https://github.com/ozkanpakdil/rust-examples/releases/download/latest/viz-rest-api
